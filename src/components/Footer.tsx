      ...
      <div className="px-6 md:px-12 relative">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-end gap-12 mb-32 relative z-10">
          ...
          <div className="w-full lg:max-w-md">
            ...
            <a
              href="https://quiz.typeform.com/to/fVT4D7rD"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block bg-[#ec4899] text-white px-12 py-5 font-bold uppercase tracking-tighter text-lg hover:bg-[#ef4444] transition-all warm-shadow"
            >
              Contact Us
            </a>
          </div>
