      ...
      <div className="absolute top-1/4 right-[-5%] lg:right-[5%] w-full lg:w-1/2 h-1/2 pointer-events-none z-0 opacity-40 lg:opacity-100">
        <svg viewBox="0 0 400 400" className="w-full h-full animate-float">
          <g fill="none" stroke="#ec4899" strokeWidth="1">
            <circle cx="200" cy="200" r="8" fill="#ef4444" className="molecule-bond" />
            ...
            <line x1="200" y1="200" x2="150" y2="140" stroke="#ec4899" className="molecule-bond" />
            <line x1="200" y1="200" x2="250" y2="140" stroke="#ec4899" className="molecule-bond" />
            <line x1="200" y1="200" x2="150" y2="260" stroke="#ec4899" className="molecule-bond" />
            <line x1="200" y1="200" x2="250" y2="260" stroke="#ec4899" className="molecule-bond" />
            <path
              d="M100,100 L150,140 M300,100 L250,140 M100,300 L150,260 M300,300 L250,260"
              strokeDasharray="4 4"
              className="opacity-20"
            />
            <circle cx="80" cy="120" r="3" fill="#ef4444" className="animate-pulse" />
            <circle cx="320" cy="240" r="3" fill="#ef4444" className="animate-pulse [animation-delay:1s]" />
            <circle cx="120" cy="350" r="3" fill="#ef4444" className="animate-pulse [animation-delay:2s]" />
          </g>
        </svg>
      </div>
      ...
      <div className="max-w-7xl relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-end">
          ...
          <div className="flex gap-4">
            <a
              href="#join"
              className="flex-1 md:flex-none text-center bg-[#ec4899] text-white px-10 py-5 text-xl font-bold uppercase tracking-tighter hover:bg-[#ef4444] transition-all warm-shadow"
            >
              Decelerate Crisis
            </a>
          </div>
